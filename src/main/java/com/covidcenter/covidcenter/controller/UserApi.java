...
public class UserApi {
    ...
    public ResponseEntity<?> Login(@RequestBody String u){
        ...
        try {
            ...
            if (user.getHashedPassword().equals(userR.getPassword())){      // comparing the password with the hashedpassword
                //login
            ...
            } else {  return new ResponseEntity<>("Incorrect email or password", HttpStatus.NOT_FOUND);
