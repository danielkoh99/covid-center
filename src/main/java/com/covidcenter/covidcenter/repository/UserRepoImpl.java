...
public class UserRepoImpl implements IUserRepo {
    ...
    public int addUser(user u) {
        ...
        return template.update(sql, u.getCprNumber(), u.getName(), u.getSurname(), u.getAge(), u.getEmail(),
                u.getPassword(), u.getToken(), u.getLoginTime(), u.getUserType().getType().getCode());
